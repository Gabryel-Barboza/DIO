...
- Adicionar a possibilidade de ordenar uma lista, seja do carrinho ou da lista de desejos.
- Adicionar capacidade de aumentar a quantidade de um item no carrinho.
